    ...
    if ($container.hasClass('feedback')) {
      ...
      $(function () {
        $stars.popover({
          ...
          content: `<div class="my-0 py-0"> <textarea type="text" style="font-size: 0.78rem" class="md-textarea form-control py-0" placeholder="Write us what can we improve" rows="3"></textarea> <button id="voteSubmitButton" type="submit" class="btn btn-outline-sm btn-primary">Submit!</button> <button id="closePopoverButton" class="btn btn-outline-flat btn-sm">Close</button>  </div>`
        });
      })
    }
