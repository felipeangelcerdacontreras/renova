...
if ($años[0]->años_transcurridos <= 0 ) {
    $años[0]->años_transcurridos = 1;
}
    ...
    <table style="margin-top: -10px;border: #00 1px solid;">
        ...
        <tr>
            <td>
                ...
                ?>
                <Label style="font-size:11">Día en que termina sus vacaciones: &nbsp;del:&nbsp;  <u style="font-size:11"> <?= $dfecha ?> </u></Label>
                <label style="font-size:11"><u> <?= $oVacaciones->MESES[$mfecha] ?> </u>&nbsp; del </label>&nbsp;
                <u style="font-size:11"> <?= $afecha ?> </u>
            </td>
        </tr>
